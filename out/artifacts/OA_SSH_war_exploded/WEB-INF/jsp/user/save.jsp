	...
	<script type="text/javascript">
		$(function(){
			...
			$("#loginName").blur(function(){
				//this 是传统的dom对象，$(this)转成了jquery对象
				var value = $(this).val();
				if(value != null && value.trim().length > 0){
					//发送Ajax，验证当前输入的登录名是否可用
					var url = "${pageContext.request.contextPath}/userAction_findByLoginName.do";
					$.post(url,{'login_name':$(this).val()},function(data){
						if(data == '0'){
							//当前登录名已经存在，不能使用
...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="userAction_%{user_id==null?'add':'edit'}" namespace="/" method="post">
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td width="100">所属部门</td>
                        <td>
                        	<s:select list="treeList" name="departmentId" listKey="de_id" listValue="de_name" headerKey="" headerValue="请选择部门" cssClass="SelectStyle"></s:select>
                        </td>
                    </tr>
                    <tr><td>登录名</td>
                        <td>
                        	<s:textfield id="loginName" name="login_name" cssClass="InputStyle"></s:textfield>
                        	*
							（登录名要唯一）
							<div id="showMsg"></div>
						</td>
                    ...
                    <tr><td>姓名</td>
                        <td>
                        	<s:textfield name="user_name" cssClass="InputStyle"></s:textfield>
                        *</td>
                    </tr>
					<tr><td>性别</td>
                        <td>
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
						<td width="100">岗位</td>
                        <td>
                        	<s:select name="roleIds" list="roleList" listKey="role_id" listValue="role_name" multiple="true" size="10" cssClass="SelectStyle"></s:select>
                           	 按住Ctrl键可以多选或取消选择
                        </td>
                    </tr>
                </table>
