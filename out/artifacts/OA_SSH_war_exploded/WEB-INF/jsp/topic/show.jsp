...
<div id="MainArea">
	...
	<center>
		...
		<div class="ItemBlock_Title1" style="width: 98%">
			...
			<font class="MenuPoint"> &gt; </font>
			<s:a action="forumAction_show?id=%{forum.id}" namespace="/">${forum.name}</s:a>
			<font class="MenuPoint"> &gt;&gt; </font>
			${title }
			<span style="margin-left:30px;">
				<s:a action="topicAction_addUI?forumManageId=%{forum.id}" namespace="/">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<td width="3" class="ForumPageTableTitleLeft">&nbsp;</td>
					...
					<td class="ForumPageTableTitle" align="right" style="padding-right:12px;">
						<s:a cssClass="detail" action="replyAction_addUI?topicId=%{id}" namespace="/">
					...
					<table border="0" cellpadding="0" cellspacing="1" width="100%">
						<tr>
							<td rowspan="3" width="130" class="PhotoArea" align="center" valign="top">
								...
								<!--作者名称-->
								<div class="AuthorName">${author.user_name }</div>
							</td>
						</tr>
						<tr><!-- 文章内容 -->
							<td valign="top" align="center">
		...
		<s:form id="pageForm" action="topicAction_show" namespace="/">
	...
	<s:form action="replyAction_add" namespace="/" method="post">
