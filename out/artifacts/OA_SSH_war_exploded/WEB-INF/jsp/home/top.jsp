	...
	<div id="Head1">
		...
		<div id="Head1Right">
			<div id="Head1Right_UserName">
                <img border="0" width="13" height="14" src="${pageContext.request.contextPath }/style/images/top/user.gif" /> 您好，<b>${sessionScope.loginUser.login_name }</b>
			</div>
        ...
        <div id="Head1Right_SystemButton">
            <s:a target="_parent" action="userAction_logout" namespace="/">
