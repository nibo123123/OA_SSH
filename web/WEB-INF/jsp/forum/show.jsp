	...
	<center>
		<div class="ItemBlock_Title1" style="width: 98%;">
			...
			<span style="margin-left:30px;">
				<s:a namespace="/" action="topicAction_addUI?forumManageId=%{id}">
		...
		<div class="ForumPageTableBorder">
				...
				<tbody class="dataContainer" datakey="topicList">
					<s:iterator value="recordList">
						<tr height="35" id="d0" class="template">
							...
							<td class="Topic">
							<s:a cssClass="Default" action="topicAction_show?id=%{id}">
								${title}
							</s:a></td>
							<td class="ForumTopicPageDataLine">
								<ul class="ForumPageTopicUl">
									<li class="Author">${author.user_name }</li>
									<li class="CreateTime">
			...
			<s:form id="pageForm" action="forumAction_show" namespace="/">
