						...
						<tr height="78" align="center" class="template">
							...
							<td class="ForumPageTableDataLine">
								<ul class="ForumPageTopicUl">
									<li class="ForumPageTopic">
										<s:a cssClass="ForumPageTopic" action="forumAction_show?id=%{id}" namespace="/">${name}</s:a>
									</li>
							...
							<td class="ForumPageTableDataLine">
								<ul class="ForumPageTopicUl">
									...
									<li><font color="#444444">├ 作者：</font> ${lastTopic.author.user_name}</li>
...
<s:form id="pageForm" action="forumAction_list" namespace="/"></s:form>
</body>
</html>
