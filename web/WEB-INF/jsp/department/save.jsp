            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td width="100">上级部门</td>
                        <td>
                            <s:select cssClass="SelectStyle" name="departmentParentId" list="departmentList" listKey="de_id" listValue="de_name" headerKey="" headerValue="请选择部门"></s:select>
                        </td>
                    </tr>
                    <tr><td>部门名称</td>
                        <td>
                        	<s:textfield name="de_name" value="" cssClass="InputStyle"></s:textfield>
                        *</td>
                    </tr>
                    <tr><td>职能说明</td>
                        <td>
                        	<s:textarea value="" name="de_description" cssClass="TextareaStyle"></s:textarea>
                        </td>
                    </tr>
                </table>
            </div>
