...
<div id=MainArea>
    <s:form action="roleAction_setPrivilege" namespace="/" method="post">
        ...
        <div class="ItemBlock_Title1"><!-- 信息说明 --><div class="ItemBlock_Title1">
        	<img border="0" width="4" height="7" src="${pageContext.request.contextPath}/style/blue/images/item_point.gif" /> 正在为【${role_name }】配置权限 </div> 
        </div>
								...
								<s:checkboxlist name="privilegeIds" list="privilegeList" listKey="id" listValue="name">
								 ...
								 <ul id="privilegeTree">
									 <s:iterator value="privilegeList">
									 	<li>
									 		 <input id="cb_${priId }"
								 				<s:property value="priId in privilegeIds ? 'checked' : '' "/>
								 					value="${priId }" type="checkbox" name="privilegeIds">
								 					<label for='cb_${priId }'><span class='folder' id='${priId }'>${priName }</span></label>
								 					
								 					<ul>
								 						<s:iterator value="PriChildren">
								 							<li>
								 								<input id="cb_${priId }" <s:property value="priId in privilegeIds ? 'checked' : '' "/> value="${id }" type="checkbox" name="privilegeIds">
								 										<label for='cb_${priId }'><span class='folder' id='${priId }'>${priName }</span></label>
								 								<ul>
								 									<s:iterator value="PriChildren">
								 										<li>
