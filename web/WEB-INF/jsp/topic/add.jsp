...
<!--显示表单内容-->
<div id="MainArea">
<s:form action="topicAction_add" cssStyle="margin: 0; padding: 0;" namespace="/" method="post">
	<s:hidden name="forumManageId" value="%{id}"></s:hidden>
	<div id="PageHead"></div>
	<center>
		<div class="ItemBlock_Title1">
			<div width=85% style="float:left">
				...
				<font class="MenuPoint"> &gt; </font>
					<s:a action="forumAction_show?id=%{id}" namespace="/">${name}</s:a>
				<font class="MenuPoint"> &gt;&gt; </font>
				发表新主题
			</div>
		</div>
