...
<s:form METHOD="post" NAME="actForm" action="userAction_login" namespace="/" >
    <DIV ID="CenterAreaBg">
        <DIV ID="CenterArea">
            ...
            <DIV ID="LoginInfo">
                ...
                <TABLE BORDER=0 CELLSPACING=0 CELLPADDING=0 width=100%>
                    <TR>
                        ...
                        <TD>
	                        <INPUT id="username" SIZE="20" CLASS="TextField" TYPE="text" NAME="login_name" />
	                        <s:fielderror>
	                        	<s:param>username_error</s:param>
	                        </s:fielderror>
                        </TD>
                    ...
                    <TR>
                        ...
                        <TD><INPUT id="psw" SIZE="20" CLASS="TextField" TYPE="password" NAME="password" />
                        	<s:fielderror>
	                        	<s:param>psw_error</s:param>
	                        </s:fielderror>
                        </TD>
                    </TR>
                </TABLE>
